      ...
      <Card>
        ...
        <Card.Body>
          ...
          <section className={styles.textArea}>
            <div>
              <span className={styles.highlightText}>Date: </span>
              {data.objectDate ? data.objectDate : "N/A"}
            </div>
            <div>
              <span className={styles.highlightText}>Classification: </span>
              {data.classification ? data.classification : "N/A"}
            </div>
            <div>
              <span className={styles.highlightText}>Medium: </span>
          ...
          <section className={styles.textArea}>
            <div>
              <span className={styles.highlightText}>Artist: </span>
            ...
            <div>
              <span className={styles.highlightText}>Credit Line: </span>
              {data.creditLine ? data.creditLine : "N/A"}
            </div>
            <div>
              <span className={styles.highlightText}>Dimensions: </span>
